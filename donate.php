...
<table width="900" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top" bgcolor="#FFFFFF">
		...
		<br /><br />
		<div class="instruct">
yo, the spyspace server costs $100 a month.  if you want your precious spyspace to keep working, please donate.  if your spyspace isn't working, don't donate.  i can't help you.  all proceeds will go only towards paying rent on the server.  but that means i won't be answering emails!  thanks.
<br><br><?=$ie_br?>
<?
...
if ($subscribed < 1) {
	...
	echo ("it looks like you have already donated.  has anyone ever told you how beautiful you are?  well you are. <br><br>$ie_br
...
<!--
<br><br>
<div class="disclaim">use a paypal account for instant activation.  if you pay with a credit card instead of a paypal account, make sure you click the link at the end of the process that says "CLICK HERE TO UPGRADE YOUR SPYSPACE ACCOUNT."  if your account still doesn't seem to auto-upgrade after you log out and log in, email me at spyspace@gmail.com with your username.  please try not to email me about anything else.  thanks!</div>
		

-->
</div>
<br> <br><br><?=$ie_br?>
<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onSubmit="return checkAmount();">
<table>
	<tr>
		<td>username:</td>
...
<input type="hidden" name="return" value="http://spyspace.cc/done.php">
...
recommended donation: $5.  minimum donation: $2.  donations are non-refundable.  spyspace could be blocked at any moment, make sure you understand this before donating.  
<br><br>
<br><br><br></div>
